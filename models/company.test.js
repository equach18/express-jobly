...
describe("findAll", function () {
  ...
  test("works: returns multiple companies from partial nameLike match", async function () {
  ...
  test("works: returns single matching company using nameLike filter", async function () {
  ...
  test("works: filtering by maxEmployees and minEmployees", async function () {
